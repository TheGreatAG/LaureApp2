...
public class GenericViewHolderDocente extends RecyclerView.ViewHolder implements ICostanti {
    ...
    public void setView(Tesi tesi, Context context, CustomAdapterListDocente adapter, int indice,FragmentManager fragmentManager){
        ...
        txtTaskDaSvolgere.setText(String.valueOf(tesi.esamiRichiesti.size()));
    ...
    public void setView(RichiestaTesi richiestaTesi, Context context, CustomAdapterListDocente adapter, int indice) {
